...
- **채널 전수조사 완료** — `sermon-office/research/content-map.md`.
  1,268편 중 1,069편(84%) 메타데이터 확보, 연도별·설교자별·성경책별·
  예배종류별 분포. 이 조사로 SS-008·SS-010의 엔드카드 오기를 발견해 정정(L-21)
- **백로그 8건** — 완결 8편(SS-001·002·004·007·008·009·010·011) ·
  아이디어 3편(SS-003·005·006)
- **완결 8편, 승인 대기** — SS-001·SS-002·SS-004·SS-007·SS-008·SS-009 ·
  SS-010(E-촬영, PASS 40/45 — 위험한 개인 경험 예화를 의도적으로 제외) ·
  **SS-011(E-촬영, PASS 42/45 — 전수조사로 신규 발굴한 「주기도문」 설교,
  점프컷 2구간)**
- **나레이션 포맷 사용 중단, 실제 촬영본(E-촬영) 우선.** 채널 소유자 요청 —
  실제 음성·영상 클립만, 그중에서도 아버님 얼굴이 나오는 촬영본 우선
- **수집된 설교 1,069편 (채널 전수).** 전수조사(§ 위)로 확보한 목록
  전체의 자막을 순차 수집 완료(사용자 요청 — 비용 무관하게 대본 전부
  추출). 논리 재분석·요약까지 끝난 것은 여전히 8편뿐(§ 아래) — 나머지
  1,061편은 원문 자막만 있는 상태로, 새 쇼츠 소재를 고를 때 바로 읽을
  수 있는 원자재다. `sermon-office/sermons/<id>/transcript.json`
  (자동 자막, 인용 불가 — 음성 대조 전) · `meta.json`(제목 파싱 결과)
